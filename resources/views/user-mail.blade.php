...
<body>
    <div class="w-full flex flex-wrap justify-center mx-auto bg-gray-200">
        <div class="p-6 w-1/2 bg-blue-300">
            <h5 class="text-2xl">Admin Credentials</h5>
            <h6 class="text-sm">These are your credentials to the dashboard.</h6>
            <p class="my-1 text-gray-700">Email: {{$email}}</p>
            <p class="my-1 text-gray-700">Password: {{$password}}</p><br><br><br>
